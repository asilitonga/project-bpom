	...
	<div class="container" style="margin-top:80px;">
		<div class="well text-center">
			...
			<form  class="form-inline" name="myForm" id="myForm" onSubmit="return validateForm()" action="index.php" method="post" enctype="multipart/form-data">
					...
					<div class="input-group">  <label><input type="checkbox" name="drop" value="1" /><u>Kosongkan Data Tabel Pegawai? (ceklis jika iyah)</u> </label><br>
						<br><center><input type="submit"  name="submit" class="btn btn-lg " value="Mulai Import"><br>
						<a class="btn btn-lg " href="../tabel/index.php"><i class="icon-plus"></i> Check Data </a></center>	
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
					...
					<h3>1. Tanpa ceklis  : mengupload file ke sistem<br> (saran : gunakan file excel sebelumnya yang datanya sudah ditambah).</h3>
